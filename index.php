    ...
    <div class="container">
      ...
      <div class="card my-5">
        <ul class="list-group list-group-flush">
          <li v-for="(task, index) in tasks" class="px-5 py-3 d-flex justify-content-between align-items-center list-group-item">
            <span :class="{ 'text-decoration-line-through': task.done }" @click="toggle(index)">
              {{ task.text }}
            </span>
            <span class="delete text-danger" @click="delete_task(index)">
      ...
      <div class="input-group mt-3">
        <input type="text" class="form-control" v-model="new_task" @keyup.enter="add_task" placeholder="Inserisci elemento...">
